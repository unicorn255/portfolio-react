      ...
      <section className="s-cta ss-dark">
        ...
        >
          <div className="column large-full">
            <h2 className="section-desc">Need a great reliable web hosting?</h2>
          </div>
        </div>
        ...
        <div className="row cta-content" data-aos="fade-up">
          <div className="column large-full">
            <p>
              We highly recommend{" "}
              <a href="https://www.visschers-fritzen.de/">Visschers-Fritzen</a>.
              Powerful web and Wordpress hosting. Guaranteed.
            </p>

            <a
              href="https://www.visschers-fritzen.de/"
        ...
        >
          ...
          <div className="column large-7 medium-full contact-social">
            ...
            <ul>
              <li>
                <a
                  href="https://www.facebook.com/rainer.bahls.3"
                  title="Facebook"
                >
                  Facebook
                </a>
              ...
              <li>
                <a
                  href="https://www.xing.com/profile/Rainer_Bahls2/cv"
                  title="Xing"
                >
                  Xing
                </a>
              ...
              <li>
                <a
                  href="https://www.instagram.com/rainerbahls"
                  title="Instagram"
                >
                  Instagram
                </a>
